# quick_fix_cameras.py
import os

# 创建简化版本
simple_content = '''#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""
摄像头管理API - 简化版
避免编码问题
...
filepath = r"D:\jsjxm\A-AI-BACKEND\app\api\endpoints\cameras.py"
...
print("✅ 已创建简化版cameras.py")
print("重启系统后测试 /api/v1/cameras 应该能正常工作了")